...
urlpatterns = patterns(
    ...
    url(r'^feed/(?P<pk>[0-9]+)(?P<path_params>;[.;=,\w\d\-\_]*)?/$', apps.feeds.views.FeedDetail.as_view()),
    url(r'^label/(?P<pk>[0-9]+)(?P<path_params>;[.;=,\w\d\-\_]*)?/$', apps.feeds.views.LabelDetail.as_view()),
